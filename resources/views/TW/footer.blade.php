            ...
            <div class="col-lg-6">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-7 col-12">
                        <ul class="nav flex-column services-nav">
                            <div>
                                <i class="fa fa-phone" style="width: 20px;text-align: center;margin-right: 5px;"></i><a href=""> 0919 756 006</a>
                            </div>
                            <div>
                                <i class="fa fa-envelope" style="width: 20px;text-align: center;margin-right: 5px;"></i><a href=""> contact@talentwins.co</a>
                            </div>
                            <div>
                                <i class="fa fa-skype" style="width: 20px;text-align: center;margin-right: 5px;"></i><a href=""> Talent Wins</a>
                            </div>
                        </ul>
                    </div>
